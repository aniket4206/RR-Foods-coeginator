...
<head>
  <title>Processing & Packaging | RR Foods</title>
  <meta charset="utf-8" />
...
<!--               <div class="widget widget-control-header widget-search-header" style="padding:7px 0px;">
    ...
    <section class="sub-header shop-layout-1">
      <img class="rellax bg-overlay" src="<?= base_url('assets/images/s_1.jpg') ?>" alt="">
      <div class="overlay-call-to-action"></div>
      <h3 class="heading-style-3 font-bold">PROCESSING</h3>
    </section>

    <!-- Features Area -->
    <div id="features" class="features-area">
      <div class="container">
        <img class="img-responsive imgcenter" src="<?= base_url('assets/images/pro&pack_new.svg') ?>" alt="Image">
      </div>
    </div>
    <br />
        <section class="sub-header shop-layout-1">
      ...
      <div class="overlay-call-to-action"></div>
      <h3 class="heading-style-3 font-bold">PACKAGING</h3>
    </section>
      ...
      <div class="container">
        <div class="col-md-offset-1 col-md-10">
          <table class="table" border="1" style="border-color: #333;">
            <thead>
              <tr>
                <th scope="col" style="border: 1px solid #333; text-align: center; font-weight:800;">Product</th>
                <th scope="col" style="border: 1px solid #333; text-align: center; font-weight:800;">Packaging Specification</th>
              </tr>
            </thead>
            <tbody>
              <tr class="tr_center">
                <td>Dehydrated White/Red/Pink Onion Flakes</td>
                <td>14 Kg. Poly Bag packed inside paper bag</td>
              </tr>
              <tr class="tr_center">
                <td>Dehydrated White/Red/Pink Onion Chopped, Minced, Granule, Powder</td>
                <td>10,20,25 Kg. Poly Bag packed inside cartoon packing</td>
              </tr>
              <tr class="tr_center">
                <td>Dehydrated Garlic Flakes</td>
                <td>10,20,25 Kg. Poly Bag packed inside cartoon packing</td>
              </tr>
              <tr class="tr_center">
                <td>Dehydrated Garlic Powder</td>
                <td>10,20,25 Kg. Poly Bag packed inside cartoon packing</td>
              </tr>
            </tbody>
          </table>
    ...
    <section class="boxed-sm">
      <div class="container">
        <div class="col-md-offset-1 col-md-10">
          <p class="font-weight-bold"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;&nbsp;FOR 10,20 KG BOX PACKAING EXTRA CHARGE 1.50RS.</p>
          <br>
          <h3 class="font-bold">BENEFITS OF OUR PACKAGING</h3>
          <hr><br>
          <ul>
            <li>For maintaining perfect product colour, aroma, hygiene & shelf life.</li>
            <li>Provide convenience during distribution & sale.</li>
            <li>Promotes image & Brand of enterprise.</li>
            <li>Distinguishable from other products.</li>
            <li>To Meet legal requirements for product distribution & sale.</li>
          </ul>
          <br>
          <p class="font-weight-bold"><mark style="background-color: #ff0;"><span style="font-weight:900">Marking</span> &mdash; We facilitates our own as well as private labeling & marking as per
              customer convenience.</mark></p><br><br>
        </div>
      </div>
    </section>
    <br>
  ...
  <script src="assets/js/config-inview-counter-up.js"></script>
