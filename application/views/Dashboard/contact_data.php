                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Contacts Us Data
                                </h4><br>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <u><a style="color:black;" href="mailto:<?php echo $row->email; ?>"><?php echo $row->email; ?></a></u>
                                                        </td>
                                                        <td class="text-center">
                                                            <u><a style="color:black;" href="tel:+91<?php echo $row->phone_no; ?>"><?php echo $row->phone_no; ?></a></u>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php echo $row->massage; ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php echo $row->submited_at; ?>
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-warning btn-round m-2" href="<?php echo base_url() . 'Dashboard/delete_contact/' . $row->id; ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                            } else { ?>
