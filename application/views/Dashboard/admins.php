          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title text-center">Current Admins
                  <a role="button" class="btn btn-sm btn-success btn-round float-right" href="<?= base_url('change') ?>">
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-info btn-round m-2" href="<?php echo base_url() . 'Dashboard/edit_user/' . $row->id; ?>">Edit</a>
                            </td>
                          </tr>
                        <?php }
                      } else { ?>
