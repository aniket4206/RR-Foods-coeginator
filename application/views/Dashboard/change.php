                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Admin Table</h4>
                            ...
                            <div class="card-header">
                                <h5>
                                    <a role="button" class="btn btn-sm btn-secondary btn-round float-left" href="<?= base_url('admins') ?>">
                                        <small class="">Back</small>
                                    </a>
                                    <a role="button" class="btn btn-sm btn-success btn-round float-right" href="<?= base_url('create_user') ?>">
                                        <small class="">Add Admin</small>
                                    </a>
                                </h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-warning btn-round m-2" href="<?php echo base_url() . 'Dashboard/delete/' . $row->id; ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                            } else { ?>
