                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Edit Products
                                </h4>
                            </div>
                            <div class="card-body ">
                                <?= form_open_multipart('Dashboard/update_products/' . $data[0]->id); ?>
                                ...
                                <div class="row ml-auto mr-auto align-items-center justify-content-center">
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="title" value="<?= $data[0]->title ?>" class="form-control" id="title">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            <b><label class="col-md-3">Description :</label></b>
                                            <div class="col-md-9">
                                                <textarea class="form-control textarea" name="description" id="description"><?= $data[0]->description ?></textarea>
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="size" value="<?= $data[0]->size ?>" class="form-control" id="size">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="colour" value="<?= $data[0]->colour ?>" class="form-control" id="colour">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="place_of_origin" value="<?= $data[0]->place_of_origin ?>" class="form-control" id="place_of_origin">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="processing_method" value="<?= $data[0]->processing_method ?>" class="form-control" id="processing_method">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="packaging" value="<?= $data[0]->packaging ?>" class="form-control" id="packaging">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <?php if ($data[0]->category == 'DehydratedPro') : ?>
                                                ...
                                                <?php elseif ($data[0]->category == 'SprayDriedPro') : ?>
                                                    <select class="form-control" name="category" id="category">
                                                        <option><?= $data[0]->category ?></option>
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            <b><label class="col-md-7">Active :</label></b>
                                            <div class="col-md-9">
                                                <?php if ($data[0]->active == 'Publish') : ?>
                                                    <select class="form-control" name="active" id="active">
                                                        <option><?= $data[0]->active ?></option>
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="MOISTURE_CONTENT" value="<?= $data[0]->MOISTURE_CONTENT ?>" class="form-control" id="MOISTURE_CONTENT">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="HOT_WATER_INSOLUBLE" value="<?= $data[0]->HOT_WATER_INSOLUBLE ?>" class="form-control" id="HOT_WATER_INSOLUBLE">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="ASH_CONTENT" value="<?= $data[0]->ASH_CONTENT ?>" class="form-control" id="ASH_CONTENT">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="ACID_INSOLUBLE_ASH" value="<?= $data[0]->ACID_INSOLUBLE_ASH ?>" class="form-control" id="ACID_INSOLUBLE_ASH">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="MAJOR_DEFECTS" value="<?= $data[0]->MAJOR_DEFECTS ?>" class="form-control" id="MAJOR_DEFECTS">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="FOREIGN_MATTER" value="<?= $data[0]->FOREIGN_MATTER ?>" class="form-control" id="FOREIGN_MATTER">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="T_P_C" value="<?= $data[0]->T_P_C ?>" class="form-control" id="T_P_C">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="COLIFORMS" value="<?= $data[0]->COLIFORMS ?>" class="form-control" id="COLIFORMS">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="E_COLI" value="<?= $data[0]->E_COLI ?>" class="form-control" id="E_COLI">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="MOLDS_YEASTS" value="<?= $data[0]->MOLDS_YEASTS ?>" class="form-control" id="MOLDS_YEASTS">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="STAPH_AUREUS" value="<?= $data[0]->STAPH_AUREUS ?>" class="form-control" id="STAPH_AUREUS">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="B_CEREUS" value="<?= $data[0]->B_CEREUS ?>" class="form-control" id="B_CEREUS">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="SALMONELLA" value="<?= $data[0]->SALMONELLA ?>" class="form-control" id="SALMONELLA">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Image :</label>
                                                <input type="file" class="form-control form-control-file" placeholder="Image" name="image" id="Image"> <button class="btn btn-info">Upload </button>
                                            </div>
                                        </div>
                                    </div>
