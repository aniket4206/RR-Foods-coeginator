                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Edit Admin
                                </h4>
                            </div>
                            <div class="card-body ">
                                <form method="post" action="<?php echo base_url('') . 'Dashboard/edit_user/' . $user['id']; ?>">
                                    <div class="row ml-auto mr-auto align-items-center justify-content-center">
                                        <div class="col-md-10 col-md-offset-2">
                                            <div class="form-group">
                                                <b><label class="col-md-3">Name :</label></b>
                                                <div class="col-md-9">
                                                    <input type="text" name="name" value="<?php echo set_value('name', $user['name']); ?>" class="form-control">
                                                    <p style="color: red;"><?php echo form_error('name', "*");
                                                                            ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-10 col-md-offset-2">
                                            <div class="form-group">
                                                <b><label for="sel1" class="col-md-3">Active :</label></b>
                                                <div class="col-md-9">
                                                    <?php if ($user['active'] == 'Publish') : ?>
                                        ...
                                        <div class="ml-auto mr-auto">
                                            ...
                                            <a type="submit" href="<?php echo base_url() . 'admins' ?>" class="btn btn-secondary btn-round">Back</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
